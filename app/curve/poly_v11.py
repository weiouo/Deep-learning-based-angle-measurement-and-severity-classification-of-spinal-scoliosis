...
def run_batch_evaluation(opt):
    ...
    for filename in os.listdir(image_dir):
        ...
        plt.plot(x_spline, y_eval, '--', color='green', linewidth=2.5, label='GT Spline')
        plt.plot(x_poly, y_eval, '-', color='red', linewidth=2.5, label='Poly Fit')
